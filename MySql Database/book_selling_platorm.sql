...
--
-- Host: localhost    Database: book_selling_platform
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  CONSTRAINT `books_ibfk_2` FOREIGN KEY (`seller_id`) REFERENCES `users` (`user_id`)
...
-- Dump completed on 2024-08-07 13:27:44
